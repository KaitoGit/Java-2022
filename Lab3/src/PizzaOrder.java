...
public class PizzaOrder
{
   ...
   public static void main (String[] args)
   {
      ...
      if(firstName.equalsIgnoreCase("Mike")||firstName.equalsIgnoreCase("Diana"))
      {
         discount = true;
      }
      ...
      if (inches == 10) {
         ...
         System.out.println("User input was not one of the choices,so set the pizza size to 12 and the cost to 12.99.");
         inches=12;
         cost=12.99;
      }
      ...
      {
         case 'H':
            crust="Hand-tossed"; break;
         case 'D':
            crust="Deep-dish";   break;
         case 'T':
            crust="Thin-crust";  break;
         default:System.out.println("Invalid selection: Using Hand-tossed");
         crust="Hand-tossed";
            crustType='H';
      }
